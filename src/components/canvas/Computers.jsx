import { Suspense, useEffect, useState } from "react"; // ✅ added hooks
  ...
  return (
    <mesh>
      ...
      <spotLight
        ...
        intensity={1}
        castShadow
        shadow-mapSize={[1024, 1024]} // ✅ fixed this line
      />
...
const ComputersCanvas = () => {
  ...
  useEffect(() => {
    ...
    const handlerMediaQueryChange = (event) => setIsMobile(event.matches);
